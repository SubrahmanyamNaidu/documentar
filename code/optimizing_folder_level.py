...
def build_json_with_descriptions(repo_dict):
    for key, value in repo_dict.items():
        ...
        # Combine file descriptions and folder name into a single prompt
        folder_description_prompt = f"Given the following descriptions of files in the folder '{folder_name}', summarize the overall purpose of the folder:\n"
...
if __name__=="__main__":
    ...
    # Save as JSON
    with open("opt_lawn_repo_documentation.json", "w",encoding="utf-8") as f:
        json.dump(repo_with_descriptions, f,ensure_ascii=False, indent=4)

    # Save as Markdown
    md_content = json_to_markdown(repo_with_descriptions)
    with open("opt_lawn_repo_documentation.md", "w",encoding="utf-8") as f:
        f.write(md_content)
